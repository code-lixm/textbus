...
import { createEditor, Layout, TableComponentSelectionAwarenessDelegate } from "@textbus/editor";
...
const editor = createEditor({
  ...
  setup(starter) {
    ...
    // npx
    const provide = new WebsocketProvider('ws://192.168.20.144:8888', 'collab', collaborate.yDoc)
