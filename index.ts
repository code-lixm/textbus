...
async function create() {
  ...
  const editor = createEditor({
    // readonly: true,
    autoFocus: true,
    content: '<div data-w-e-type="myTodo" data-select-userList="lin2&&7d0878e4bae54e33ab319389ef9bbf75;;林琳&&ce03ff6865874c1ca68bdf294657d7dc;;lin-过期154003&&795957a6fd3d4c61b47e3781ad5173b3;;" data-select-time="" data-select-positionId="a63cc52b-fe0a-44b8-b457-207c58c632dc"><input type="checkbox" disabled checked>非动员大会</div>',
    ...
    // content: '<ol> <li>consul优化思路</li> <ul> <li>consul&nbsp;目录配置全局变量：ys/global/local/config/xxx</li> <ul> <li> 通过&nbsp;helm.build.sh&nbsp;打包脚本配置变量，由&nbsp;ctmpl&nbsp;文件读取配置 </li> <ul> <li> 由打包的&nbsp;commit&nbsp;信息，拿到&nbsp;devops&nbsp;构建的环境变量，设置不同部署包的变量 </li> </ul> </ul> </ul> </ol>',
