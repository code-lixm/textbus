...
describe('Commander:transform 转换空白', () => {
  ...
  test('转换为普通段落', () => {
    ...
    commander.transform({
      ...
      slotFactory() {
        return new Slot([Text, InlineComponent])
      },
    })
...
//     editor = createEditor({
//       content:
//         '<ul><li>aaa</li><li>aaa</li></ul><p>ppp</p><div class="tb-jumbotron" component-name="JumbotronComponent"><div><p>test</p><p>test</p><p>test</p></div></div>',
//     })
//     const container = document.createElement('div')
//     await editor.mount(container)
...
//     expect((firstSlot.getContentAtIndex(0) as ComponentInstance).name).toBe(
//       listComponent.name
//     )
//     expect((firstSlot.getContentAtIndex(1) as ComponentInstance).name).toBe(
//       listComponent.name
//     )
//     expect((firstSlot.getContentAtIndex(2) as ComponentInstance).name).toBe(
//       jumbotronComponent.name
//     )
//     expect(
//       (firstSlot.getContentAtIndex(2) as ComponentInstance).slots.get(0)!.length
//     ).toBe(2)
//     expect(selection.getPaths()).toEqual({
//       anchor: [0, 1, 0, 1],
//       focus: [0, 1, 1, 2],
...
//       content: '<p>aaaaa</p><p>bbbbb</p><div class="tb-jumbotron" component-name="JumbotronComponent" style="background-size:cover;background-position:center;min-height:200px"><div><h1>Hello, world!</h1><p>你好，我是 Textbus，一个给你带来全新体验的富文本开发框架。</p><p>现在我们开始吧！</p></div></div>11111<p>ccccc</p><p>ddddd</p>',
//     })
//     const container = document.createElement('div')
//     await editor.mount(container)
